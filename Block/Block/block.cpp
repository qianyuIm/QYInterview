...
struct __create_block_impl_0 {
  struct __block_impl impl;
  struct __create_block_desc_0* Desc;
  __Block_byref_num_0 *num; // by ref
  __create_block_impl_0(void *fp, struct __create_block_desc_0 *desc, __Block_byref_num_0 *_num, int flags=0) : num(_num->__forwarding) {
...
static void __create_block_func_0(struct __create_block_impl_0 *__cself) {
  __Block_byref_num_0 *num = __cself->num; // bound by ref

        (num->__forwarding->num)++;
        printf("%d", (num->__forwarding->num));
    }
static void __create_block_copy_0(struct __create_block_impl_0*dst, struct __create_block_impl_0*src) {_Block_object_assign((void*)&dst->num, (void*)src->num, 8/*BLOCK_FIELD_IS_BYREF*/);}

static void __create_block_dispose_0(struct __create_block_impl_0*src) {_Block_object_dispose((void*)src->num, 8/*BLOCK_FIELD_IS_BYREF*/);}

static struct __create_block_desc_0 {
  size_t reserved;
  size_t Block_size;
  void (*copy)(struct __create_block_impl_0*, struct __create_block_impl_0*);
  void (*dispose)(struct __create_block_impl_0*);
} __create_block_desc_0_DATA = { 0, sizeof(struct __create_block_impl_0), __create_block_copy_0, __create_block_dispose_0};
int create() {
    __attribute__((__blocks__(byref))) __Block_byref_num_0 num = {(void*)0,(__Block_byref_num_0 *)&num, 0, sizeof(__Block_byref_num_0), 10};
    void (*myBlock)(void) = ((void (*)())&__create_block_impl_0((void *)__create_block_func_0, &__create_block_desc_0_DATA, (__Block_byref_num_0 *)&num, 570425344));
